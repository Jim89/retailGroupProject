...
We also computed the statistical significances of differences between heavy and light users for a number of buying behaviours. The results each time indiciated that the differences were statistically significant (appendix four). 
